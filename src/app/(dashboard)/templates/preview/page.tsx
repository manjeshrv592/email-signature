...
export default async function SignaturePreviewPage({
  ...
  const { user: selectedUserId, template: selectedTemplateId } =
    await searchParams;
    ...
    <div className="max-w-5xl">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-white flex items-center gap-3">
          <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-pink-500 to-rose-500 shadow-lg">
      ...
      {selectedUserId && !result && (
        <div className="bg-[#12121a] border border-[#1e1e2e] rounded-2xl p-12 text-center">
          ...
          <p className="text-[#555] text-sm max-w-md mx-auto">
            No default template found, or the user was not found. Create a
            template and set it as default first.
          </p>
        </div>
      )}
